...
<html lang="en">
<head>
	<body style="background-image: url(proj17.jpg); background-repeat: no-repeat;background-size: 100% 100%;">
<meta charset="utf-8">
...
<form method="post" >
	...
	<?php include('leftbar.php');?>
		...
		<div id="page-wrapper" style="background-image: url('rcrds2.jpg'); background-repeat: no-repeat; background-size:cover;">
			<div class="row">
				<div class="col-lg-12">
...
<option VALUE="">SELECT</option>
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Select Elective Subject<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
 <input class="form-control" name="c-full"  id="c-full" >
       </select>
       <label><h4> Electives: (NCC,Horse Riding, Singing,Dancing,Drawing,Yoga,Karate,Music Band ,Boxing)</h4></label>
	</div>
	 </div>	
	...
	<br><br>		
			...
			<div class="col-lg-4">
			<input class="form-control" name="income"  id="income"required="required" >
	...
	<br><br><br><br>		
      ...
      <textarea class="form-control" rows="3" name="cadd"  id="cadd"></textarea>
        ...
        <div class="row">
			<div class="col-lg-12">
			<div class="panel panel-default">
			<div class="panel-heading">Academic Informations(10th and 11th) Mathematics & Biology</div>
			<div class="panel-body">
			<div class="row">
