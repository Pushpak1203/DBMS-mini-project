...
<body style="background-image: url(proj19.jpg); background-repeat: no-repeat;background-size: 100% 100%;">
    ...
    <div id="wrapper">
      ...
      <?php include('leftbar.php')?>;
         ...
         <nav>
        <div id="page-wrapper" style="background-image: url(proj20.jpg);background-size:100% 100%;" >
            <div class="row">
                <div class="col-lg-12">
