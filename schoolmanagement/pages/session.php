        ...
        <div id="page-wrapper">
			...
			<label>Session<span id="" style="font-size:11px;color:red">*</span></label>
				  ...
				  <?php while($res=$rs->fetch_object()){
				   if($res->status==1){ ?>
		 <input type="radio" name="gender" id="radio-<?php echo $res->session;?>" value="<?php echo $res->session;?>" checked required="required">
		 &nbsp;&nbsp;<?php echo $res->session;?> <br>
		<?php  } else { ?>
		 <input type="radio" name="gender" id="radio-<?php echo $res->session;?>" value="<?php echo $res->session;?>" required="required">
		 &nbsp;&nbsp;<?php echo $res->session;?> <br>
		 <?php }?>
