<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
                ...
                <div class="sidebar-nav navbar-collapse">
                 ...
                 <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Elective Subject<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="add-subject.php">Add Elective Subject</a>
                                </li>
                                <li>
                   ...
                   <li>
                            <a href="register.php"><i class="fa fa-bar-chart-o fa-fw"></i>Regsiter</a>
                  </li>     
