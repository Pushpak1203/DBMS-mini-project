...
<head>
	...
	<body style="background-image:url('proj1.jpg')">;
...
<form method="post" >
	<div id="wrapper">
<!-- Navigation --><?php include('leftbar.php')?>;

<!--nav-->
		<div id="page-wrapper"style="background-image: url('proj8.jpg'); background-repeat: no-repea;background-size: 100% 100%;">
			<div class="row">
				<div class="col-lg-12">
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Class Short Name<span id="" style="font-size:11px;color:red">*</span>	</label>
											</div>
											<div class="col-lg-6">
  ...
  <input class="form-control" name="course-short" id="cshort" required="required"  onblur="courseAvailability()">       
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Class Full Name<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<input class="form-control" value="<?php echo date('d-m-Y');?>" readonly="readonly" name="cdate">
		...
		<br><br>		
							...
							<input type="submit" class="btn btn-primary" name="submit" value="Create Elective subject"></button>
											</div>
